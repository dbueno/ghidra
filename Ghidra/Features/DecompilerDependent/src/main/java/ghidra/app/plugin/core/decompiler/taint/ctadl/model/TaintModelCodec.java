  ...
  public static List<TaintModel> decode(String s){
    ...
    for (String line : s.split("\n")){
      ...
      TaintModel m = switch (TaintModel.Role.valueOf(f[0])){
        case SOURCE -> TaintModel.source(names, f[2], f[3]);
        case SINK   -> TaintModel.sink(names, f[2], f[3]);
        case PROPAGATION -> TaintModel.propagation(names, f[4], f[5]);
      };
